    ...
    return (
        <section className={`${value.mode ? "bg-white" : "bg-gray-900"}`}>
            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                <h2 className={`text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl ${value.mode ? "text-black" : "text-white"}`}>
                        ...
                        <blockquote className={`rounded-lg p-6 shadow-sm sm:p-8 ${value.mode ? 'bg-gray-50' : 'bg-blue-200'}`}>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className={`mt-0.5 text-lg font-medium ${value.mode ? 'text-gray-900' : 'text-black'} `}>Paul Starr</p>
                                </div>
                            </div>

                            <p className={`mt-4 ${value.mode ? 'text-gray-700' : 'text-black'} `}>
